...
urlpatterns = patterns('',
    ...
    url(r'^show/(?P<ee_fake_key>[\w|\W|-|0-9]{10,50})/?$', 'incident.views.show_this_incident', name="show-specific-incident"),
    ...
    url(r'^score/(?P<pk>\d+)/$', 'incident.views.admin_score', name='admin-scoring'),
    )
